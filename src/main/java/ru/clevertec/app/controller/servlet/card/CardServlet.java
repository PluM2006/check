...
//
//    @Autowired
//    private CheckService<CardDTO, Card> cardCheckService;
//
//    @Override
//    public void init() {
...
//        Optional<CardDTO> cardOptional = cardCheckService.add(card);
...
//        Optional<CardDTO byId;
//        CustomList<CardDTO> allPage;
